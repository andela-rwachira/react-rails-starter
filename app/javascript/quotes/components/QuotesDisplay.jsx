...
class QuotesDisplay extends React.Component {
  ...
  /* React Router provides location.search which returns the query string
    i.e. for http://our-website/?quotes=1, location is ?quotes=1. 
    But RR doesn't parse the string for us so we need to use the query-sting
    library
  */
